...
public class RestUserDetails {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/createblogpost")
	public Response createBlogpost(BlogPost blogpost, @QueryParam("userid") String userid) {
	...
	public Response createBlogpost(@QueryParam("postid") String postid,Comments comment) {
